...
CREATE TABLE IF NOT EXISTS standings (
    ...
    season VARCHAR(20) NOT NULL DEFAULT '2025',
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
...
('Luton Town', 'LUT', '#F78F1E', '#241F20', '#000000'),
...
('Sheffield United', 'SHU', '#EE2737', '#FFFFFF', '#000000'),
('Southampton', 'SOU', '#D71920', '#FFFFFF', '#000000'),
