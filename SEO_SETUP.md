...
The sitemap is configured to use `https://premieleaguematches.com` by default.
...
- `NEXT_PUBLIC_SITE_URL`: Used in sitemap generation. If not set, defaults to `https://premieleaguematches.com`.

## Verification Checklist

After setup, verify:

- [ ] Sitemap is accessible at `https://premieleaguematches.com/sitemap.xml`
- [ ] Robots.txt is accessible at `https://premieleaguematches.com/robots.txt`
- [ ] Robots.txt points to correct sitemap URL (`https://premieleaguematches.com/sitemap.xml`)
...
1. **Submit Sitemap to Google Search Console**:
   ...
   - Add your property: `https://premieleaguematches.com`
   - Submit your sitemap URL: `https://premieleaguematches.com/sitemap.xml`

2. **Submit Sitemap to Bing Webmaster Tools**:
   - Go to [Bing Webmaster Tools](https://www.bing.com/webmasters)
   - Add your site: `https://premieleaguematches.com`
   - Submit sitemap: `https://premieleaguematches.com/sitemap.xml`
